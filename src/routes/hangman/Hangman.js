...
class Hangman extends Component {
  ...
  render() {
    return (
      <Container className="hangBack"style={{backgroundColor:"black"}}>
        <div className="App" tabIndex="1" onKeyUp={this.handleKeyUp}>
          <Name className="text-center" style={{fontFamily: "Times New Roman Times serif",textDecoration:"underline",color:"azure"}}>Hangman</Name>
          <SubTitle className="text-center" newGame={this.state.newGame} style={{fontFamily: "Times New Roman Times serif",color:"azure"}}>Guess the movie</SubTitle>
