...
const OnePieceChar = lazy(() => import('../routes/Animes/OnePiece/OPCharacters.js'));
const OnePiece = lazy(() => import('../routes/Animes/OnePiece/OnePiece.js'))
                ...
                <Router>
                    <Suspense fallback={<div>Loading...</div>}>
                        <Switch>
                            ...
                            <Route path="/OPStory" component={OPStory} />
                            <Route path="/OPVideos" component={OPVideos} />
                            <Route path="/About" component={About} />
                            <Route path="/OPCharacters" component={OnePieceChar} />
